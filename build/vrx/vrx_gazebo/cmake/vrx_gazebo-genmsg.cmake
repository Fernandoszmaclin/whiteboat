...
set(MSG_I_FLAGS "-Ivrx_gazebo:/home/fernando/vrx_ws/src/vrx/vrx_gazebo/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/fernando/vrx_ws/src/vrx/vrx_gazebo/msg/Task.msg" NAME_WE)
add_custom_target(_vrx_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "vrx_gazebo" "/home/fernando/vrx_ws/src/vrx/vrx_gazebo/msg/Task.msg" ""
)

get_filename_component(_filename "/home/fernando/vrx_ws/src/vrx/vrx_gazebo/msg/Contact.msg" NAME_WE)
add_custom_target(_vrx_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "vrx_gazebo" "/home/fernando/vrx_ws/src/vrx/vrx_gazebo/msg/Contact.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/fernando/vrx_ws/src/vrx/vrx_gazebo/srv/ColorSequence.srv" NAME_WE)
add_custom_target(_vrx_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "vrx_gazebo" "/home/fernando/vrx_ws/src/vrx/vrx_gazebo/srv/ColorSequence.srv" ""
)

get_filename_component(_filename "/home/fernando/vrx_ws/src/vrx/vrx_gazebo/srv/BallShooter.srv" NAME_WE)
add_custom_target(_vrx_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "vrx_gazebo" "/home/fernando/vrx_ws/src/vrx/vrx_gazebo/srv/BallShooter.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/vrx_gazebo)
  ...
  string(REGEX REPLACE "([][+.*()^])" "\\\\\\1" ESCAPED_PATH "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/vrx_gazebo")
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/vrx_gazebo
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
